...
def answered_call():
    ...
    if os.path.exists(file_path):
        ...
        response.play(url="https://cda6-47-151-56-38.ngrok-free.app/static/audio/output.mp3")
...
def gather_input():
    ...
    gather = Gather(input='speech', action='/process_speech', method='POST', timeout='auto')  # Adjust the timeout as needed
